oojs.define({
    ...
    createCallback: function (callback, needTimes, emitTimes) {
        ...
        return {callback:callback, data:null, needTimes:needTimes, emitTimes:emitTimes  };
    },
    ...
    createEvent: function (eventName) {
        var result = {name: eventName, callbacks: [], callbackData: [], emitData: [], status: false, groups: {}};
        return result;
    },
